...
set_property IOSTANDARD LVCMOS33 [get_ports WF_INTR]
...
set_property PACKAGE_PIN K16 [get_ports WF_INTR]
...
set_output_delay -clock [get_clocks GPS_TCXO] -max -add_delay 1.000 [get_ports WF_INTR]	    ; # CTRL_WF_INTR
set_output_delay -clock [get_clocks GPS_TCXO] -min -add_delay -1.000 [get_ports WF_INTR]
