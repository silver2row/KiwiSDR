...
var user_login=conn_kiwi?w3_innerHTML('id-kiwi-user-login').trim():'';var s=isNonEmptyString(user_login)?(user_login+'<br><br>'):'KiwiSDR: software-defined receiver<br>';s+=s1+try_again+
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Wed Mar 11 08:22:45 2026) */
var w3={CAPTURING:true,BUBBLING:false,RETAIN_FOCUS:true,_last_:0};var w3int={btn_grp_uniq:0,menu_cur_id:null,menu_active:false,menu_debug:false,menu_close_func:null,prev_menu_hover_el:null,reload_timeout:null,reload_seq:0,rate_limit:{},rate_limit_need_shift:{},rate_limit_evt:{},eventListener:[],_last_:0};var w3_console={};w3_console.log=function(obj,prefix){var s=prefix?(prefix+': '):'';if(isString(obj)){s+='"'+obj.toString()+'"';}else
...
return true;}
function kiwi_map_waterfall_add_queue(what,ws,firstChars){var kmap=ws.gen_cb_param;if(kiwi.wf_preview_mode){waterfall_add_queue2(what,ws,firstChars);kmap.preview_lines++;if(kmap.preview_lines==2){wf_aper_cb('wf.aper',kiwi.APER_MAN);setTimeout(wf_autoscale_cb,1);}}else{if(kiwi_gc_wf)what=null;}}
...
w3_innerHTML(kmap.submit_status,'Waterfall preview: '+kmap.wf_id2);kmap.wf_ws=open_websocket('W/F',function(){kiwi.wf_preview_mode=true;kmap.preview_lines=0;kmap.wf_ws.send("SET auth t=kiwi");kmap.wf_ws.send("SERVER DE CLIENT openwebrx.js W/F");kmap.wf_ws.send("SET ident_user=WF_preview");kmap.wf_ws.send("SET send_dB=1");kmap.wf_ws.send('SET zoom='+zoom_level+' start='+x_bin);kmap.wf_ws.send("SET maxdb=0 mindb=-100");kmap.wf_ws.send("SET wf_speed=3");kmap.preview_timeo=setTimeout(function(){if(kmap.wf_ws)kmap.wf_ws.close();},10000);},kmap,null,kiwi_map_waterfall_add_queue,kiwi_map_wf_preview_error_cb,kiwi_map_waterfall_close,{url:kmap.wf_url_full,proxy2:true,new_ts:true,qs:'',all_msg_cb:kiwi_map_all_msg_cb,gen_cb_param:kmap,trace:0});kmap.wf_conn_bad=false;kmap.wf_ws_bad=false;}
...
/* web/kiwi/waterfall.min.js (web/kiwi/waterfall.js = Sat Aug  9 17:51:35 2025) */
...
/* web/openwebrx/openwebrx.min.js (web/openwebrx/openwebrx.js = Fri Apr 17 15:17:46 2026) */
...
var zoom_center=0.5;var ZOOM_NOMINAL=9,ZOOM_BAND=6;var zoom_nom=0,zoom_old_nom=0;var zoom_levels_max=0;var zoom_level=0;var zoom_level_f=0;var zoom_freq=0;var zoom_span_Hz=0;var zoom_maxin_s=['id-maxin','id-maxin-nom','id-maxin-max'];var x_bin=0;function zoom_step(dir,arg2){if(wf.audioFFT_active){audioFFT_update();return;}
...
if(dir==ext_zoom.NOM_IN||dir==ext_zoom.MAX_IN){if(dir==ext_zoom.NOM_IN&&isNumber(arg2)&&arg2==1&&zoom_level>=zoom_nom){if(zoom_level==zoom_levels_max)
...
if(shortcut.ext_key[key]){w3_call(shortcut.ext_key[key]);ignore_next_keyup_event=true;return false;}
