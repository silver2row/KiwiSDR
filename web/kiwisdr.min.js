...
/* web/extensions/ext.min.js (web/extensions/ext.js = Fri Jul 17 16:25:31 2026) */
...
function extint_panel_show(controls_html,data_html,show_func,hide_func,show_help_button){var el;extint.using_data_container=(data_html?true:false);if(extint.using_data_container){toggle_or_set_spec(toggle_e.SET,spec.NONE);w3_hide('id-top-container');el=w3_el('id-ext-data-scroll');el.style.minWidth=px(kiwi.WIN_WIDTH_EXT);w3_innerHTML(el,data_html);w3_show_block('id-ext-data-container');}else{w3_hide('id-ext-data-container');if(spec.source==spec.NONE)
...
/* web/kiwi/w3_util.min.js (web/kiwi/w3_util.js = Fri Jul 17 10:47:14 2026) */
