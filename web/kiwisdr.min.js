...
/* web/extensions/ext.min.js (web/extensions/ext.js = Fri Jul 17 13:51:43 2026) */
...
function ext_panel_init(){w3_el('id-panels-container').innerHTML+='<div id="id-ext-controls" class="class-panel" data-panel-name="ext-controls" data-panel-pos="bottom-left" data-panel-order="0" '+'data-panel-size="'+extint.default_w+','+extint.default_h+'"></div>';var el;el=w3_el('id-ext-controls');el.innerHTML=w3_div('id-ext-controls-container w3-relative|width:100%;height:100%;')+
...
function extint_panel_show(controls_html,data_html,show_func,hide_func,show_help_button){var el;extint.using_data_container=(data_html?true:false);if(extint.using_data_container){toggle_or_set_spec(toggle_e.SET,spec.NONE);w3_hide('id-top-container');el=w3_el('id-ext-data-scroll');el.style.minWidth=px(kiwi.WIN_WIDTH_MAX);w3_innerHTML(el,data_html);w3_show_block('id-ext-data-container');}else{w3_hide('id-ext-data-container');if(spec.source==spec.NONE)
