	...
	var controls_html =
		w3_div('id-s4285-controls w3-text-aqua',
			w3_divs('/w3-tspace-8',
				...
				w3_select('w3-text-red', 'Mode', '', 's4285.mode', s4285.mode, mode_s, 's4285_mode_select_cb'),
				w3_slider('', 'Gain', 's4285.gain', s4285.gain, 0, 100, 1, 's4285_gain_cb'),
				w3_select('w3-text-red', 'Draw', '', 's4285.draw', s4285.draw, draw_s, 's4285_draw_select_cb'),
