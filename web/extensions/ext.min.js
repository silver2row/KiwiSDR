...
function ext_set_data_width(width){var el=w3_el('id-ext-data-scroll');if(!width){if(el)el.style.minWidth=px(kiwi.WIN_WIDTH_EXT);}else{if(el)el.style.minWidth=px(width);}}
